...
**Actor:** System
**Requirement traceability:** REQ-3.2.3, REQ-6.1.5, REQ-6.1.6
...
- `[ASSUMPTION]` Padding bytes at positions 3 and 40–43 are read but discarded. The `read_u32(buf, 40)` call for padding is not assigned to any envelope field.
