...
| **Current worst case** | ~1,326 B / 9 frames (Chain 5: DTLS outbound + Logger); 11 frames / ~1,154 B (Chain 3: retry pump + Logger) — DEF-031-1 resolved: flush-path stack ~130 KB → ~592 B |
